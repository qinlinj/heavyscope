...
- Settings → Local data: Paste JSON fills the import textarea from the clipboard (`navigator.clipboard.readText`). Success and failure flash in zh-CN / en. Does not auto-apply.
